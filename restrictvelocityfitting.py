...
for r in range(Nr):
    ...
    if r==0:
            p = lmfit.Parameters()
            p.add_many(('nc', 0.85,True,0.7,1), ('Tc_pal', 8*10**5,True,1*10**5,10*10**5), ('Tc_per', 8*10**5,True,1*10**5,10*10**5), ('Ts_pal', 17*10**5,True,1*10**5,20*10**5), ('Ts_per', 17*10**5,True,1*10**5,20*10**5), ('Uc',0,True,-3.,0),('Us',0,True,0,0.5))
    else:                          
            p = lmfit.Parameters()

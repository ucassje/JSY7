...
def G_per_e(a,b,x):
    ...
    if (a**2+b**2)**0.5/v_th_function(Temperature_tol[l])<1 and abs(b)>0:
        d=2*(r_s**3)*(Density_next[l])/(np.pi**0.5)*(0.5/b)*((2/(3*v_th_function(Temperature_tol[l])))-(2/15)*((a**2+b**2)/v_th_function(Temperature_tol[l])**3)+(1/10)*((a**2+b**2)**2/v_th_function(Temperature_tol[l])**5))
        ...
        d=(r_s**3)*(Density_next[l])*v_th_function(Temperature_tol[l])**2*(0.5/b)*(0.5/(a**2+b**2)**1.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function(Temperature_tol[l]))*np.exp(-(a**2+b**2)/v_th_function(Temperature_tol[l])**2)+(2*(a**2+b**2)/v_th_function(Temperature_tol[l])**2-1)*special.erf((a**2+b**2)**0.5/v_th_function(Temperature_tol[l])))
    elif (a**2+b**2)**0.5/v_th_function(Temperature_tol[l])>=1 and abs(b)==0:
...
def G_per_p(a,b,x):
    ...
    if (a**2+b**2)**0.5/v_th_function_p(Temperature_tol[l])<1 and abs(b)>0:
        d=2*(r_s**3)*(Density_next[l])/(np.pi**0.5)*(0.5/b)*((2/(3*v_th_function_p(Temperature_tol[l])))-(2/15)*((a**2+b**2)/v_th_function_p(Temperature_tol[l])**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(Temperature_tol[l])**5))
        ...
        d=(r_s**3)*(Density_next[l])*v_th_function_p(Temperature_tol[l])**2*(0.5/b)*(0.5/(a**2+b**2)**1.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function_p(Temperature_tol[l]))*np.exp(-(a**2+b**2)/v_th_function_p(Temperature_tol[l])**2)+(2*(a**2+b**2)/v_th_function_p(Temperature_tol[l])**2-1)*special.erf((a**2+b**2)**0.5/v_th_function_p(Temperature_tol[l])))
    elif (a**2+b**2)**0.5/v_th_function_p(Temperature_tol[l])>=1 and abs(b)==0:
    ...
    for i in range(Nv):
            for j in range(Nv):
                    if R==0:
                            ...
                            if i==0:
                                    A[i,j] =1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==1 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-1 else 0
                            elif i==Nv-2:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                    else:
                            if i==0:
                                    A[i,j] =1+Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R])-Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        ...
                        if i==0:
                                A[i,j] =1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==1 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-1 else 0
                        elif i==Nv-2:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==i else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                else:
                        if i==0:
                                A[i,j] =1+Exp*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-Exp*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+Exp*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:

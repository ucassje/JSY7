...
#AalphaA=dot(AA_1,alphaA)
        ...
        #if k==600:
        #        np.save('data_600.npy', f_1)
        
        #if k==800:
        #        np.save('data_800.npy', f_1)

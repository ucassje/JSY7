...
def Matrix_A(R,M):
    ...
    for i in range(Nv):
            for j in range(Nv):
                    if R==0:
                            if i==0:
                                    A[i,j] =1+0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==1 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    A[i,j] =0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-1 else 0
                            elif i==Nv-2:
                                    A[i,j] =0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                    elif R==Nr-1:
                            if i==0:
                                    A[i,j] =1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==1 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-1 else 0
                            elif i==Nv-2:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                    else:
                            if i==0:
                                    A[i,j] =1+rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        ...
                        if i==0:
                                B[i,j] =rect_v(per_v[M])*(Fv/4)*((U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R])*per_v[M]/2)+rect_v(per_v[M])*(Fv/4)*(-Col*H_perp(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_e(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_p(pal_v[i],per_v[M],z[R])) if j==0 else rect_v(per_v[M])*rect_v(pal_v[i])*(Fvv/8)*(Col*(-G_pal_per_e(pal_v[i],per_v[M],z[R])+G_pal_per_p(pal_v[i],per_v[M],z[R]))) if j==1 else 0
                        elif i==Nv-1:
                                B[i,j] =-rect_v(per_v[M])*rect_v(pal_v[i])*(Fvv/8)*(-Col*(G_pal_per_e(pal_v[i],per_v[M],z[R])+G_pal_per_p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else rect_v(per_v[M])*(Fv/4)*((U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R])*per_v[M]/2)+rect_v(per_v[M])*(Fv/4)*(-Col*H_perp(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_e(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_p(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                B[i,j] =-rect_v(per_v[M])*rect_v(pal_v[i])*(Fvv/8)*(-Col*(G_pal_per_e(pal_v[i],per_v[M],z[R])+G_pal_per_p(pal_v[i],per_v[M],z[R]))) if j==i-1 else rect_v(per_v[M])*(Fv/4)*((U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R])*per_v[M]/2)+rect_v(per_v[M])*(Fv/4)*(-Col*H_perp(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_e(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_p(pal_v[i],per_v[M],z[R])) if j==i else rect_v(per_v[M])*rect_v(pal_v[i])*(Fvv/8)*(-Col*(G_pal_per_e(pal_v[i],per_v[M],z[R])+G_pal_per_p(pal_v[i],per_v[M],z[R]))) if j==i+1 else 0
                else:
                        if i==0:
                                B[i,j] =rect_v(per_v[M])*(Fv/4)*((U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R])*per_v[M]/2)+rect_v(per_v[M])*(Fv/4)*(-Col*H_perp(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_e(pal_v[i],per_v[M],z[R]))+rect_v(per_v[M])*(Fv/4)*(-Col/2*G_per_p(pal_v[i],per_v[M],z[R])) if j==0 else rect_v(per_v[M])*rect_v(pal_v[i])*(Fvv/8)*(Col*(-G_pal_per_e(pal_v[i],per_v[M],z[R])+G_pal_per_p(pal_v[i],per_v[M],z[R]))) if j==1 else 0
                        elif i==Nv-1:
...
def Matrix_C(R,M):
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        C[i,j] =0*rect_v(per_v[M])*(Fvv/8)*(-Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/8)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R]))) if j==i else 0
                else:
                        C[i,j] =rect_v(per_v[M])*(Fvv/8)*(-Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/8)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R]))) if j==i else 0 
    return C
...
def Matrix_Q(R,M):
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        if i==0:
                                A[i,j] =1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==0 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==1 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                                A[i,j] =-0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==Nv-1 else 0
                        elif i==Nv-2:
                                A[i,j] =-0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==Nv-2 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==i else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                elif R==Nr-1:
                        if i==0:
                                A[i,j] =1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==1 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-1 else 0
                        elif i==Nv-2:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==i else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                else:
                        if i==0:
                                A[i,j] =1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
...
for p in range(updatetime):
        ...
        for k in range(timestep):
                ...
                for j in range(Nv):
                       for i in range(Nv):
                               if f_1[(j)*Nv+i,Nr-1]/np.amax(f_1)>1:
                                       solu1[j,i]=0
                               elif f_1[(j)*Nv+i,Nr-1]/np.amax(f_1)>10**(-10):
                                       solu1[j,i]=np.log10(f_1[(j)*Nv+i,Nr-1]/np.amax(f_1))
                               else:
                                       solu1[j,i]=-10
                fig = plt.figure()
                fig.set_dpi(500)
                ...
                plt.text(pal_v[Nv-23],pal_v[Nv-4], r'$r/r_s=$' "%.2f" % z[Nr-1], fontsize=12)
                ...
                for j in range(Nv):
                       for i in range(Nv):
                               if f_1[(j)*Nv+i,20]/np.amax(f_1)>1:
                                       solu1[j,i]=0
                               elif f_1[(j)*Nv+i,20]/np.amax(f_1)>10**(-10):
                                       solu1[j,i]=np.log10(f_1[(j)*Nv+i,20]/np.amax(f_1))
                               else:
                                       solu1[j,i]=-10
                fig = plt.figure()
                fig.set_dpi(500)
                ...
                plt.text(pal_v[Nv-13],0.5,r'$\mathcal{v}_\parallel/\mathcal{v}_{Ae0}$', fontsize=12)
                plt.text(0.,pal_v[Nv-4],r'$\mathcal{v}_\perp/\mathcal{v}_{Ae0}$', fontsize=12)
                plt.text(pal_v[Nv-23],pal_v[Nv-4], r'$r/r_s=$' "%.2f" % z[20], fontsize=12)
                plt.colorbar(label=r'$Log(F/F_{MAX})$')

        ...
        for j in range(Nv):
                for i in range(Nv):
                        if per_v[j]<0:
                                ...
                                temp=temp+2*np.pi*pal_v[i]*0.5*G_per_2e(pal_v[i],per_v[j],z[r])*((f_1[j*Nv+i+2,r]-2*f_1[j*Nv+i,r]+f_1[j*Nv+i-2,r])/(4*delv**2))*abs(per_v[j])*(pal_v[1]-pal_v[0])**2
        e_col_G2[r]=Col*temp
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        ...
                        if i==0:
                                A[i,j] =1+0*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+0*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+0*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+0*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==1 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                        ...
                        if i==0:
                                ...
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1+0*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+0*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-1 else 0
                        elif i==Nv-2:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+0*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+0*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+0*(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])+0*(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==i else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])+pal_v[i]*dcos(z[R])/cos(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
    return A

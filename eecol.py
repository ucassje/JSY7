...
for k in range(300):
	...
	for j in range(Nv):
            if per_v[j]>0:
                    for i in range(Nv):
                            if a==pal_v[i] and abs(b)==per_v[j]:
                                    temp=temp
                            else:
                                    temp=temp+2*np.pi*((((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-1/2))-(((abs(b))-per_v[j])**2)*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*f_1(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
            else:
                    temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*((((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-1/2))-((a-pal_v[i])**2)*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*f_1(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*(-(a-pal_v[i])*((abs(b))-per_v[j])*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*f_1(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*((((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-1/2))-(((abs(b))-per_v[j])**2)*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*Collision_Proton(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                               if a==pal_v[i] and abs(b)==per_v[j]:
                                       ...
                                       temp=temp+2*np.pi*((((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-1/2))-((a-pal_v[i])**2)*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*Collision_Proton(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*(-(a-pal_v[i])*((abs(b))-per_v[j])*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*Collision_Proton(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*(-((abs(b))-per_v[j])*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*Collision_Proton(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
                ...
                if per_v[j]>0:
                        for i in range(Nv):
                                if a==pal_v[i] and abs(b)==per_v[j]:
                                        ...
                                        temp=temp+2*np.pi*(-(a-pal_v[i])*(((a-pal_v[i])**2+((abs(b))-per_v[j])**2)**(-3/2)))*Collision_Proton(pal_v[i],per_v[j],r)*per_v[j]*(delv)**2
                else:
                        temp=temp
	return temp
    ...
    def Matrix_A(R,M):
        ...
        for i in range(Nv):
                for j in range(Nv):
                        if R==0:
                            if i==0:
                                    A[i,j] =1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==0 else 0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==1 else 0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else -0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==Nv-1 else 0
                            elif i==Nv-2:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==Nv-2 else 0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==i else 0*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                        elif R==Nr-1:
                            if i==0:
                                    A[i,j] =1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==0 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==1 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    ...
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==Nv-2 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0*0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==i else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                        else:
                            if i==0:
                                    A[i,j] =1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==0 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==1 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-3 else -(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-2 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==Nv-1 else 0
                            elif i==Nv-2:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==Nv-2 else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1-(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))-(delt/2)*(4*np.pi*Col)*f_1(pal_v[i],per_v[M],z[R])+0.5*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*(t[1]-t[0])/z[R])+(delt/2)*sin(z[R])*(sin(z[R])*dU_solar(z[R])+U_solar(z[R])*dsin(z[R])) if j==i else (Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(cos(z[R])*dU_solar(z[R])+dcos(z[R])*U_solar(z[R]))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else (Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0

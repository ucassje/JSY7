...
ax.set_ylabel(r'$U_{bulk}/v_{Ae0}$', fontsize=28)
...
ax.set_xlabel(r'$r/r_s$', fontsize=28)
ax.set_ylabel(r'$U_s/v_{Ae0}$', fontsize=28)
ax.plot(z,WS,linewidth=3.0, color='k',label=r'$U_s/v_{Ae0}$');
...
ax.plot(z,max(Density)*(z[0]/z)**2*(WS[0]/(WS)),linewidth=3.0, color='b',linestyle='dashdot',label=r'$1/(U_sr^{2}) \ Profile$');
